<template>
  <div class="topNavWrapper">
    ...
    <div v-if="needToLogin" class="twitchConnectBtn">
        <a href="https://api.twitch.tv/kraken/oauth2/authorize?response_type=token+id_token&client_id=yb1fpw6w2ldfn50b0ynr50trdcxn99&redirect_uri=http://localhost:8080/&scope=viewing_activity_read+openid&state=c3ab8aa609ea11e793ae92361f002671">Connect Twitch</a>
    </div>
  </div>
</template>
